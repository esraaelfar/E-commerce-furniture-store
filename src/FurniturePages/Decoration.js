    ...
    return (
        ...
        <Form>
            <FormGroup check inline>
                <Input type="checkbox" />
                <Label check>Mirror</Label>
            </FormGroup>
            <FormGroup check inline>
                <Input type="checkbox" />
                <Label check>Clock</Label>
            </FormGroup>
            <FormGroup check inline>
                <Input type="checkbox" />
                <Label check>Lights</Label>
            </FormGroup>
        </Form>
    </div>
